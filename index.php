<?php
    $questions = [
        [
            "requests" => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
        ...
        [
            "requests" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
        ...
        [
            "requests" => "Perché il mio account è associato a un paese?",
        ...
        [
            "requests" => "Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?",
        ...
        [
            "requests" => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?",
